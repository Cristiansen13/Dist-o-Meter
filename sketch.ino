 ...
 * 
 * Lesson 30: Show Distance on 4 Digit Display. Timer
 * 
 * The code below is created for the lesson "Show distance on 4 digit display. Timer",
...
void calculate_distance()
{
  ...
  if (distance < 10) {
    ...
    // Instructions for the first branch (e.g., turn on white LED).
    digitalWrite(red, HIGH);
    digitalWrite(green, LOW);
    digitalWrite(blue, LOW);
  } else if (distance < 25) {
    // If the distance is between 10 and 20 units:
    // Instructions for the second branch (flashing effect with blue LED).
    digitalWrite(red, HIGH);
    digitalWrite(green, HIGH);
    digitalWrite(blue, LOW);
  } else if (distance < 50) {
    // If the distance is between 20 and 30 units:
    // Instructions for the third branch (flashing effect with red LED).
    digitalWrite(red, HIGH);
    digitalWrite(green, HIGH);
    digitalWrite(blue, HIGH);
  } else {
    // If the distance is 50 units or more:
    // Instructions for the sixth branch (turn on green LED).
    digitalWrite(green, HIGH);
